...
const Content = () => {
  ...
  return (
    <div className={`content ${DarkTheme && "dark"}`}>
      ...
      <div className="row header">
        <Card Icon={AiOutlineUsergroupAdd} title="totalStudents" value="80" />
        <Card Icon={RiChat3Line} title="Messages" value="+ 4" />
        <Card Icon={AiOutlineLike} title="Likes" value="+ 15" />
        <Card Icon={FcRating} title="Rating" value="" />
        ...
        <section>
          ...
          <div className="summary">
            ...
            <span className="summary-info">
              The Peerformancec of your student can be seen in your mobile. His peformane is gppd but not upto the mark he
              has to work hard to get more good marks.He has the potential to do that.Besides he is very goog in Athletics.
            </span>
          </div>
      ...
      <div className="row side-rect">
        <section>
          ...
          <div className="more-details">
            <h1 className="title">Behavior</h1>
            <span className="txt">
              He maintains a good discipline in class, comes to class regulary.
            </span>
          </div>
        </section>
      </div>
      <div className="row side-rect">
        <section>
          ...
          <div className="more-details">
            ...
            <span className="txt">
              He has secured good  marks in chemistry so chemmistry is his strong part but
              the marks in rest of the 2 subjets is not good
            </span>
          </div>
        </section>
      </div>
